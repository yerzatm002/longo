package kz.meirambekuly.backendlongo.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("kz.meirambekuly.backendlongo"))
                .build()
                .apiInfo(metaData());
    }
    ...
    private ApiInfo metaData() {
        ApiInfo apiInfo = new ApiInfo(
                ...
                "Spring Boot REST API for Longo Project",
                "1.0",
                "Terms of service",
                "Meirambekuly Yerzat",
